...
ds_H = freqz(ds_Bs, ds_As, iec_w, Fs);
...
clf;
hold on;
semilogx(iec_w, ds_e_dB, 'g;ICS-43432 Datasheet plot (estimated);');
semilogx(iec_w, 20 * log10 (abs (ds_H)), 'r;IIR filter frequency response;');
semilogx(iec_w, (ds_e_dB + 20*log10(abs(eq_H))), 'b;Adjusted frequency response;', 'linewidth', 3);
